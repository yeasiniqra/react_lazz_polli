                ...
                <div className="booking-room-main">
                    <div className="row">
                        <div className="col-md-7">
                            <div className="grid">
                                <figure className="effect-layla">
                                    <img src={FindHroom[0].image} alt="Dusai Rooms" />
                                    <figcaption>
                        ...
                        <div className="col-md-5">
                            <div className="grid">
                                <figure className="effect-layla">
                                    <img src={FindHroom[1].image2} alt="Dusai Rooms" />
                                    <figcaption>
                    ...
                    <div className="row custom-rows">
                        <div className="col-md-5">
                            <div className="grid">
                                <figure className="effect-layla">
                                    <img src={FindHroom[2].image3} alt="Dusai Rooms" />
                                    <figcaption>
                        ...
                        <div className="col-md-7">
                            <div className="grid">
                                <figure className="effect-layla">
                                    <img src={FindHroom[3].image4} alt="Dusai Rooms" />
                                    <figcaption>
